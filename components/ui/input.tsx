    ...
    return (
      <div className="relative">
        <input
          ...
          className={cn(
            "text-textColor !mt-[0.375rem] flex h-10 w-full rounded-md border border-inputBorder bg-background px-3 py-2 text-sm outline-none file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-sm placeholder:text-placeholder focus-visible:outline-primary disabled:cursor-not-allowed disabled:opacity-50 sm:w-[70vw] lg:w-[39.5rem]",
            className,
          )}
          ref={ref}
          {...props}
